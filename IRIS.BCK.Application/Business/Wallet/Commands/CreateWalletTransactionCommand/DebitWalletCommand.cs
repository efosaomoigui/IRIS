...
{
    public class DebitWalletCommandHandler : IRequestHandler<DebitWalletCommand, CreateWalletTransactionCommandResponse>
    {
        private readonly IWalletTransactionRepository _walletTransactionRepository;
        private readonly IMapper _mapper;
        private readonly IEmailService _emailService;

        public DebitWalletCommandHandler(IWalletTransactionRepository walletTransactionRepository, IMapper mapper, IEmailService emailService)
        {
        ...
        public async Task<CreateWalletTransactionCommandResponse> Handle(DebitWalletCommand request, CancellationToken cancellationToken)
        {
            var CreateWalletTransactionCommandResponse = new CreateWalletTransactionCommandResponse();
            var validator = new DebitWalletCommandValidator(_walletTransactionRepository);
    ...
    public class DebitWalletCommand : IRequest<CreateWalletTransactionCommandResponse>
    {
