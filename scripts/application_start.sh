#!/bin/bash
 ...
 sudo chown -R ubuntu:ubuntu /home/ubuntu/IRIS.BCK.Infrastructure.Files/
 sudo chmod -R 777 /home/ubuntu/IRIS.BCK.Infrastructure.Persistence/
 sudo chown -R ubuntu:ubuntu /home/ubuntu/IRIS.BCK.Infrastructure.Persistence/
