...
namespace IRIS.BCK.Core.Domain.EntityEnums
{
    public enum TrackingStatus
    {
        ...
        Processing_Completed_,_Ready_For_Dispatched = 20,

        [Description("Shipment Registerred For Dispatch")]
        Shipment_Registerred_For_Dispatch = 30,
        ...
        Shipment_At_Destination_,_Ready_For_Delivery_Processing = 50,
