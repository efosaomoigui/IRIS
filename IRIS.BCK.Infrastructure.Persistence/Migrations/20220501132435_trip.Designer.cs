...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IRIS.BCK.Core.Domain.Entities.Monitoring.TrackHistory", b =>
                {
                    ...
                    b.Property<Guid?>("TripTrackId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("TripTrackId");
            ...
            modelBuilder.Entity("IRIS.BCK.Core.Domain.Entities.Monitoring.TrackHistory", b =>
                {
                    b.HasOne("IRIS.BCK.Core.Domain.Entities.ShipmentProcessing.Trips", "TripTrack")
                        .WithMany()
                        .HasForeignKey("TripTrackId");

                    b.Navigation("TripTrack");
                });
